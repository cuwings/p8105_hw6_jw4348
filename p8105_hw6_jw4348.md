...
- Based on summary, most estimates are significant. The prediction seems
  pretty good.
...
- Also, there are some outliers, particularly for higher fitted values,
  should be investigated further as they can have a significant
